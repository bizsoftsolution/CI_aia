	...
	<div class="panel panel-flat">
        <div class="panel-heading">
         ...
         <table class="table datatable-button-print-columns">
            ...
            <?php
            $i=1;
			$mList = $this->db->get_where('tbl_aia_details',array('status'=>'MAILED'))->result();
            ...
            ?>
              ...
              <td style="text-align:center">
               <a href="<?php echo base_url(); ?>Members/viewDataToAppove/<?php echo $row->id;?>"  title="Disable" class="btn bg-danger remove" >Approve</a>
              </td>
              </tr>
              <?php $i++;}?>
