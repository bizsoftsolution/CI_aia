   ...
   <div class="col-lg-12">
      ...
      <div class="panel panel-flat">
         <div class="panel-heading">
			...
			<div class="col-md-6">
				<h3 class="panel-title">Achivements Edit
			</h3>
			</div>
			<div class="col-md-6">
         ...
         <div class="container-fluid">
            ...
            <div class="col-md-12">
               ...
               <div class="alert alert-success">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                  <strong>Success !!! </strong> Achivements Updated successfully
               </div>
               <?php } ?>
               <?php foreach($achivements as $row){?>
				<div class="col-md-12">
		<form class="form-horizontal form-validate-jquery" action="<?php echo  base_url();?>Achivement/achivementEdit/<?php echo $row->id;?>" method="POST" enctype="multipart/form-data">
			<div class="col-md-12">
				<div class="panel panel-flat">
					...
					<div class="panel-body">
						<fieldset class="content-group">
							...
							<div class="col-md-9">
								...
								{
									?>
										<img src="<?php echo base_url().'upload/achivements/'.$row->images;?>" class="img-responsive" style="width:250px;height:150px;">
