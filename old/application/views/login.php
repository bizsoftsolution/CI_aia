							...
							<div class="tab-pane fade in active" id="basic-tab1">
								<form  action="<?php echo base_url();?>User/varifyUser" method="post">
									<div class="text-center">
										<img class="img-responsive" src="<?php echo base_url('assets/image001.gif');?>" style="display:block; margin:0 auto;">
										<!--h1 class="text-blue-600">AIA</h1-->
...
<!--
									...
									<div class="form-group">
										<button type="submit" class="btn bg-blue-600 btn-block" style="background:#d4003b;border:1px solid #d4003b;">Login <i class="icon-arrow-right14 position-right"></i></button>
									</div>
									<p style="text-align:center">Don't have account?<a href="<?php echo base_url(); ?>Register"> Register here</a></p>
								</form>
